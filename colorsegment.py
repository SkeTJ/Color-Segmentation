...
#Resize the image so it will fit properly, the sizing is
#not based on monitor size but on the image resolution
def ResizeImage(img):
        scale = 35
...
while(1):   
        ...
        res_red = cv2.putText(res_red, 'Red', (0,25), cv2.FONT_HERSHEY_SIMPLEX,
        ...
        res_green = cv2.putText(res_green, 'Green', (0,25), cv2.FONT_HERSHEY_SIMPLEX,
        ...
        res_blue = cv2.putText(res_blue, 'Blue', (0,25), cv2.FONT_HERSHEY_SIMPLEX,
        ...
        res_yellow = cv2.putText(res_yellow, 'Yellow', (0,25), cv2.FONT_HERSHEY_SIMPLEX,
        ...
        cv2.imshow('Comparison', ogandoutline_image)
        cv2.imshow('Split Colours', splitcoloured_Image)
